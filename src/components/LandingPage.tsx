...
const FeatureCard: FC<FeatureCardProps> = ({
  ...
  return (
    <div
      className={`group relative bg-white/50 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-8 hover:shadow-2xl hover:scale-105 transition-all duration-500 ${
...
export default function LandingPage() {
  ...
  const testimonials = [
    {
      ...
      content:
        "Business Doctor helped me validate my SaaS idea in just 2 weeks. The AI insights were incredible!",
      rating: 5,
    },
    {
      ...
      content:
        "From concept to launch in 30 days. The expert validation gave me the confidence I needed.",
      rating: 5,
    },
    {
      name: "Emily Watson",
      ...
      content:
        "The financial modeling feature saved me months of work. Absolutely game-changing!",
      rating: 5,
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 text-gray-900 ">
      <TopNavBar />
      <FloatingElements />
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-16 overflow-hidden">
        <div className="max-w-5xl mx-auto z-10">
          <div className="inline-flex items-center space-x-2 bg-blue-100/80 backdrop-blur-sm text-blue-800 px-4 py-2 mt-20 rounded-full text-sm font-medium mb-8 animate-bounce">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            Our intelligent AI assistant works alongside experienced business
            coaches to help you develop, validate, and launch your business with
            confidence.
          </p>
          <div className="flex items-center justify-center gap-8">
            <Link to={"/client/dashboard"}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center space-x-2 cursor-pointer">
            ...
            <Link to={"/prices"}>
             <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <button className="group relative px-8 py-4  text-black rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center space-x-2 border-3 border-black cursor-pointer">
      ...
      <section className="relative py-24 px-4 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-16 leading-relaxed">
            Our intelligent AI works alongside you to develop your business
            plan, conduct market research, and prepare for expert validation.
          </p>
                ...
                <div className="text-left space-y-4">
                  <div className="bg-blue-50 rounded-2xl p-4 ml-16">
                    <p className="text-gray-700">
                      I've analyzed your market and identified 3 key
                      opportunities. Would you like me to create a detailed
                      business plan for the most promising one?
                    </p>
                  </div>
                  <div className="bg-gray-100 rounded-2xl p-4 mr-16">
                    <p className="text-gray-700">
                      Yes, let's focus on the SaaS opportunity. Can you also
                      include financial projections?
                    </p>
                  </div>
                  <div className="bg-blue-50 rounded-2xl p-4 ml-16">
                    <p className="text-gray-700">
                      Perfect! I'm generating a comprehensive 5-year financial
                      model with funding scenarios. This will take about 2
                      minutes...
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              human expertise to give you the best of both worlds.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                After your AI-assisted business plan is complete, our subject
                matter experts review and validate your plan to ensure it's
                viable and ready for launch.
              </p>
                ...
                <div className="bg-white rounded-2xl p-8">
                  ...
                  <div className="text-left">
                    <h3 className="text-xl font-semibold mb-3">
                      1:1 Expert Review Session
                    </h3>
                    <p className="text-gray-600 mb-4">
                      Schedule a session with an industry expert to validate
                      your business plan before launch.
                    </p>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
        <div className=" w-[100vw] flex justify-center">
          <span className="text-3xl md:text-4xl font-bold mb-16">
            Our Prices
          </span>
        </div>
        <div>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl mb-12 leading-relaxed opacity-90 max-w-2xl mx-auto">
            Start your journey with our AI assistant and get expert validation
          ...
          <div className="text-sm opacity-75">
            ✨ No credit card required • 🚀 Launch in 30 days • 💯 Expert
            validation included
          </div>
        </div>
      </section>
      <footer className="border-t border-white-700/50 bg-white-900/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="border-t border-slate-700/50 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm mb-4 md:mb-0">
              © 2025 Business Doctor. All rights reserved.
            </p>
